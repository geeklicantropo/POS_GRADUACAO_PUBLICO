...
import torch
import torch_dwn as dwn  # Correctly import torch_dwn
...
class DynamicPreprocessor:
    ...
    def preprocess_data(self, num_bits=3):
        ...
        # Update the label column name to 'malware' or 'label' based on your CSV file
        label_column_name = 'malware'  # Update if your CSV has a different label column
...
def main():
    ...
    dynamic_treated_data_dir = os.path.join(project_dir, 'dados', 'dynamic', 'treated_data')
